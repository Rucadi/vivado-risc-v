...
proc create_root_design { parentCell } {
  ...
  assign_bd_address -offset 0x00000000 -range $addr_range -target_address_space [get_bd_addr_spaces IO/Ethernet2/M_AXI] [get_bd_addr_segs RocketChip/DMA_AXI4/reg0] -force
