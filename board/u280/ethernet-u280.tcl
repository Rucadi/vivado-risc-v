...
set_property -dict [list \
    CONFIG.CHANNEL_ENABLE {X0Y41} \
    CONFIG.TX_MASTER_CHANNEL {X0Y41} \
    CONFIG.RX_MASTER_CHANNEL {X0Y41} \
    CONFIG.TX_LINE_RATE {10.3125} \
    CONFIG.TX_REFCLK_FREQUENCY {161.1328125} \
    CONFIG.TX_USER_DATA_WIDTH {64} \
    CONFIG.TX_INT_DATA_WIDTH {64} \
    ...
    CONFIG.RX_USER_DATA_WIDTH {64} \
    CONFIG.RX_INT_DATA_WIDTH {64} \
    CONFIG.RX_REFCLK_SOURCE {X0Y41 clk1} \
    CONFIG.TX_REFCLK_SOURCE {X0Y41 clk1} \
    CONFIG.FREERUN_FREQUENCY {125} \
